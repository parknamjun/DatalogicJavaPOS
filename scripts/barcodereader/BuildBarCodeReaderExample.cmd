...
@echo.
@echo --------------------------------
@echo BuildBarCodeReaderExample.cmd builds
...
@echo.
@echo BuildBarCodeReaderExample.cmd does not use NetBeans.
...
@echo on
javac @..\scripts\barcodereader\javac_params.txt
@echo off
...
move /y ..\src\BarCodeReaderExample.jar 1>NUL
copy /y ..\scripts\barcodereader\BarCodeReaderExample.cmd 1>NUL
copy /y ..\scripts\barcodereader\BarCodeReaderExample.sh 1>NUL
...
move /y ..\src\barcodereaderexample\*.class 1>NUL
