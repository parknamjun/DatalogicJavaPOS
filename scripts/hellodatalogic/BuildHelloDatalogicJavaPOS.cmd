...
@echo.
@echo --------------------------------
@echo BuildHelloDatalogicJavaPOS.cmd builds
...
@echo.
@echo BuildHelloDatalogicJavaPOS.cmd does not use NetBeans.
...
@echo on
javac @..\scripts\hellodatalogic\javac_params.txt
@echo off
...
move /y ..\src\HelloDatalogicJavaPOS.jar 1>NUL
copy /y ..\scripts\hellodatalogic\HelloDatalogicJavaPOS.cmd 1>NUL
copy /y ..\scripts\hellodatalogic\HelloDatalogicJavaPOS.sh 1>NUL
copy /y ..\jpos.xml 1>NUL
copy /y ..\brand.properties 1>NUL
copy /y ..\dls.properties 1>NUL
cd ..
...
move /y ..\src\hellodatalogicjavapos\*.class 1>NUL
